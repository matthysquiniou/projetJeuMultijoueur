...
public:
	...
	void CreateBoatHull(float length, float width, float height, XMFLOAT3 color);
	void CreateCannon(float barrelLength, float barrelRadius, float offsetY, XMFLOAT3 color);
	void CreateIcebergBlock(float length, float width, float height, XMFLOAT3 color);
};
